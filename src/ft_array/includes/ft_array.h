...
t_array		*ftarray__init_data(
	void *start, int nb_element, size_t element_size);
...
t_array		*ftarray__extract_by_func(
	t_array *array, int(*f)(void *, void *), void *param);
t_array		*ftarray__copy(t_array *src);
t_array		*ftarray__copy_func(
	t_array *src, int(*f)(void *, void *, void *), void *param);
void		ftarray__free(t_array **p_array);
void		ftarray__free_func(
	t_array **p_array, int (*f)(void *, void *), void *param);
int			ftarray__free_func_str(void *element, void *p);
int			ftarray__remove_func(
	t_array *array, int index, void (*f)(void *, void *), void *param);
...
void		*ftarray__func(
	t_array *array, int(*func)(void *, void *), void *param);
...
int			ftarray__cmp(
	t_array *array_1, t_array *array_2, int (*f)(void *, void *));
